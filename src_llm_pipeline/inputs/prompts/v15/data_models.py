...
class CognitiveAppraisalAndConceptualization(BaseModel):
    ...
    rationale: str = Field(
        ...,
        description=(
            "**Include a clear short rationale explaining how you arrived at your conclusions, *supported by specific examples from the text and your research.* Consider how **external contextual factors** like cultural norms or social trends might contribute to the observed cognitive processes.**"
        )
    )
...
class CulturalAndSocialContext(BaseModel):
    ...
    rationale: str = Field(
        ...,
        description=(
            "**Include a clear short rationale explaining how you arrived at your conclusions, *supported by specific examples from the text and your research.* Consider how **external contextual factors** like political events or historical context might contribute to the observed cultural and social influences.**"
        )
    )
...
class EmotionConstructionAnalysis(BaseModel):
    ...
    rationale: str = Field(
        ...,
        description=(
            "**Include a clear short rationale explaining how you arrived at your conclusions, *supported by specific examples from the text and your research.* Consider how **external contextual factors** like individual experiences or social media trends might contribute to the observed emotion construction process.**"
        )
    )
...
class EmotionalDynamicsAndChanges(BaseModel):
    ...
    rationale: str = Field(
        ...,
        description=(
            "**Include a clear short rationale explaining how you arrived at your conclusions, *supported by specific examples from the text and your research.* Consider how **external contextual factors** like the topic of discussion or the online community's culture might contribute to the observed emotional dynamics.**"
        )
    )
